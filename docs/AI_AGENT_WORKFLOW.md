...
5. Read `docs/ENGINEERING_WORKFLOW.md`.
6. Read `docs/CODING_STANDARDS.md`.
7. Inspect the existing implementation before proposing or making changes.
8. Identify affected docs and folder-level knowledge docs before editing.
...
7. Summarize changed files, tests run, and any follow-up work.
