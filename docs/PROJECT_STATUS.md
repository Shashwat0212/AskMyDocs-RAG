...
- Review and acceptance of Day Zero foundation.
...
2. Review and accept the updated Phase 1 Core RAG MVP plan with post-MVP reranking, session memory, and hyperparameter experimentation epics.
...
Do not implement application features until a feature ticket is created and assigned. Read `AGENTS.md` and `docs/AI_AGENT_WORKFLOW.md` before starting work.
